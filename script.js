...
//Menu - Hamburger
const menuTlElm = document.querySelector('#menu-tlacitko');

menuTlElm.addEventListener('click', () => {
  document.querySelector('#menu-polozky').classList.toggle('show');
});

//Seznam filmů
const filmyElm = document.querySelector('#seznam-filmu');
filmy.forEach((film) => {
  filmyElm.innerHTML += `
	<div class="col">
  <div class="card">
